...
export const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="py-24 bg-white dark:bg-navy-950 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {portfolioData.services.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="p-7 sm:p-8 rounded-3xl bg-slate-50 dark:bg-navy-900 border border-slate-200/80 dark:border-navy-800 shadow-sm hover:shadow-xl dark:shadow-navy-950/40 transition-all duration-300 flex flex-col justify-between space-y-6 group glow-card"
              >
                <div className="space-y-4">
                  
                  {/* Service Icon */}
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-blue-600 to-cyan-500 flex items-center justify-center text-white shadow-md shadow-cyan-500/20 group-hover:scale-110 transition-transform">
                ...
                <div className="pt-4 border-t border-slate-200/60 dark:border-navy-800 space-y-3">
                  ...
                  <a
                    href="#contact"
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 group-hover:translate-x-1 transition-all"
                  >
